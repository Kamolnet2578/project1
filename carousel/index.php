    ...
    <a class="nav-link active-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
      เข้าสู่ระบบ
         ...
         <ul class="dropdown-menu">
 		 ...
 		 <li class="nav-item"><a class="nav-link active-primary" aria-current="page" href="contect.php">ติดต่อเรา</a><li>
          </li>
         </li>
        </ul>
           ...
           width="100%" height="280" >
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                <p><a href="detail.php?pid=<?=$data['p_id'];?>" type="button" class="btn btn-sm btn-primary">รายละเอียด</a></p>
