<?php
		session_start();
		include_once("../album/connect.php");
?>
<!doctype html>
...
<main class="form-signin w-100 m-auto">
  ...
  <center>
    <a class="navbar-brand" href=""><img src="images/1.jpg" width="150" height="150" /></a>
    <h1 class="h3 mb-3 fw-normal">IDEAL HOME-เข้าสู่ระบบ</h1>
...
<?php
		if(isset($_POST['Submit'])){
			...
			if ($num > 0){
				...
				echo "<script>";
				echo "window.location = '../album/index1.php';";
